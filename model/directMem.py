...
class directMem(nn.Module):
    def __init__(self, dim_input, nmem, lr=1e-3, alpha=0.5, tau=0.1, dropout_rate=0):
        super(directMem, self).__init__()
    ...
    def forward(self, X, sceneid, storage):
        ...
        return loss, self.storage, log_loss, log_acc, log_h, log_m, log_q, log_yhat, log_attn, log_m_sc
    ...
    def retrieve_memory(self):
        ...
        d = self.q_t.size(-1)
        self.attn = (self.q_t.reshape(1, -1) @ values.T) / (self.tau * d ** 0.5)
